...
class FrameChessboard(tk.Frame):
    ...
    def get_current_item(self, event):
    ...
    def board_squares(self):
        ...
        self.board.pack()
        #self.board.bind('<Button-1>', self.controller.highlight_moves_by_clicking_on_square)
        ...
        self.board.bind('<Button-1>', self.get_current_item)
        self.board.bind(item2, '<B1-Motion>', self.move)
        self.board.bind(item2, '<ButtonRelease-1>', self.release)
        self.move_flag = False
