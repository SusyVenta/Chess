...
class Queen:
    ...
    def get_all_allowed_moves(self, start_tag):
        ...
        vertical_moves = Rook().get_vertical_moves_possible(current_coordinate_letter, current_coordinate_number)
        horizontal_moves = Rook().get_horizontal_moves_possible(current_coordinate_letter, current_coordinate_number)
        up_rightwards = Bishop().move_up_rightwards(current_coordinate_number, current_coordinate_letter)
        up_leftwards = Bishop().move_up_leftwards(current_coordinate_number, current_coordinate_letter)
        down_leftwards = Bishop().move_down_leftwards(current_coordinate_number, current_coordinate_letter)
        down_rightwards = Bishop().move_down_rightwards(current_coordinate_number, current_coordinate_letter)
